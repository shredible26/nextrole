...
- **Global scope**: `/Users/shreyvarma/Desktop/nextrole/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/shreyvarma/Desktop/nextrole/.claude/notes/`)
...
2. Glob `/Users/shreyvarma/Desktop/nextrole/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/shreyvarma/Desktop/nextrole/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/shreyvarma/Desktop/nextrole/.claude/notes/` — works in any directory
