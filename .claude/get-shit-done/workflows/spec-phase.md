...
```bash
INIT=$(node "/Users/shreyvarma/Desktop/nextrole/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/shreyvarma/Desktop/nextrole/.claude/get-shit-done/templates/spec.md.
