...
```
Task(
  prompt="Read /Users/shreyvarma/Desktop/nextrole/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/shreyvarma/Desktop/nextrole/.claude/get-shit-done/templates/SECURITY.md`
